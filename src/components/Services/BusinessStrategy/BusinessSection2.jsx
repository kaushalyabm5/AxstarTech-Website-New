...
import businessImg2 from "../../../assets/business-img-2.png";

const BusinessSection2 = () => {
  const deliverables = [
    "Digital transformation roadmap", 
	"Process automation & optimization strategy", 
  ...
  return (
    <section id='section2' className="w-full min-h-screen bg-[#000000] text-white flex items-center justify-center px-6 py-16 overflow-hidden">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <h2 className="text-3xl font-light md:text-5xl leading-tight text-[#e9e7e2] mb-16">Digital Transformation Consulting</h2>
          ...
          >
            We enable organizations to transform digitally by integrating modern technologies, optimizing processes, and enhancing customer experiences.
          </motion.p>
        </div>
