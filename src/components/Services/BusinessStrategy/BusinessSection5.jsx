...
const BusinessSection5 = () => {
  ...
  return (
    <section id='section5' className="w-full min-h-screen bg-[#000000] text-white flex items-center justify-center px-6 py-16 overflow-hidden">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <h2 className="text-3xl font-light md:text-5xl leading-tight text-[#e9e7e2] mb-16">Startup Advisory</h2>
          ...
          >
           We support startups to validate ideas, accelerate growth, and scale effectively with the right strategy, technology, and investor readiness.
          </motion.p>
        </div>
...
export default BusinessSection5;