...
import businessImg3 from "../../../assets/business-img-3.jpeg";
...
const BusinessSection3 = () => {
  ...
  return (
    <section id='section3' className="w-full min-h-screen bg-[#000000] text-white flex items-center justify-center px-6 py-16 overflow-hidden">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <h2 className="text-3xl font-light md:text-5xl leading-tight text-[#e9e7e2] mb-16">Go-To-Market (GTM) Strategy</h2>
          ...
          >
           At Axstar, we develop data-driven go-to-market strategies that accelerate market entry, strengthen positioning, and drive revenue growth.
          </motion.p>
        </div>
