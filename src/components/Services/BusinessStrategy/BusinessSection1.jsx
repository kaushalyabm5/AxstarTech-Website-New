...
import businessImg1 from "../../../assets/business-img-1.jpeg";
...
const BusinessSection1 = () => {
  ...
  return (
    <section id="section1" className="w-full min-h-screen bg-[#000000] text-white flex items-center justify-center px-6 py-16 overflow-hidden">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <h2 className="text-3xl font-light md:text-5xl leading-tight text-[#e9e7e2] mb-16">Business Model & Growth</h2>
          ...
          >
            At Axstar, we design and optimize scalable business models that unlock new
            revenue streams and accelerate sustainable growth in competitive markets.
          </motion.p>
        </div>
